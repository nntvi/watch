                                    ...
                                    <tr>
                                        ...
                                        <td class="clearfix">
                                            ...
                                            <ul class="list-operation fl-right">
                                                <li><a href="<?php echo $item['pro_update'];  ?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                <li><a href="<?php echo $item['pro_delete'];  ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </td>

            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST"  enctype="multipart/form-data">
                        ...
                        <textarea name="post_head" id="desc" class="ckeditor"><?php echo $item['post_head']; ?></textarea>
                        ...
                        <input type="radio" name="status" value="0" <?php if($item['post_status'] == 0){ echo "checked"; }?>>Ẩn                       
                        <input type="radio" name="status" value="1" <?php if($item['post_status'] == 1){ echo "checked"; }?>>Hiển thị
                        
                        <label>Hình ảnh</label>
                        <div id="uploadFile" >
                            <input type="file" name="file" id="upload-thumb" value="">
                            <!-- <input type="submit" name="btn-upload-thumb" value="Upload" id="btn-upload-thumb"> -->
                            <img src="../admin/public/uploads/<?php echo $item['post_thumb']; ?>">
                        </div>

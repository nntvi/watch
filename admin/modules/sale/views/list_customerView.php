            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><span class="count">Tất cả (<?php echo $count['count_customer']; ?>)</span></li>
                        </ul>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        ...
                                                        <!-- <li><a href="?mod=sale&action=deletecustomer&id=<?php echo $item['cus_id'] ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li> -->
                                                    </ul>
                                                </td>
                ...
                <div class="section" id="paging-wp">
                    <div class="section-detail clearfix">
                        <p id="desc" class="fl-left">Xóa toàn bộ danh sách thì mọi đơn hàng sẽ xóa</p><br>
                        <a href="?mod=sale&action=deleteall">Xóa toàn bộ danh sách</a>
                        <ul id="list-paging" class="fl-right">
                            <?php
                            echo get_pagging($num_page, $page, "?mod=sale&action=list_customer");
                            ?>
                        </ul>
                    </div>
                </div>
